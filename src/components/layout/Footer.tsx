...
import { ArrowUp, Server, Gamepad2, Shield, Monitor, Newspaper, Activity, ScrollText, Lock, MessageCircle, HelpCircle, Phone } from "lucide-react";
...
const columns = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Instagram", href: "https://www.instagram.com/cloudonfire_", icon: Gamepad2, external: true },
    ],
  },
  {
    title: "Legal",
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <Link to="/" className="inline-block mb-5">
              <img src={logo} alt="Cloud on Fire" className="h-10 w-auto" />
            </Link>
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.instagram.com/cloudonfire_"
                target="_blank"
